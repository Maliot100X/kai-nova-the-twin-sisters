...
async function main() {
    ...
    console.log('');
    line();
    console.log('  Done. Starting Kai&Nova The Twin Sisters...');
    line();
    console.log('');
    ...
    try {
        ...
        console.log('');
        console.log('  Kai&Nova are now alive.');
        console.log('  They will message you on Telegram shortly.');
        console.log('');
    } catch(e) {
        // pm2 not installed - fallback message
        console.log('  pm2 not found. Start them manually:');
        console.log('    node src/kai-nova.js');
        console.log('');
