...
module.exports = {
    ...
    JORK_NAME: process.env.JORK_NAME || 'Kai&Nova The Twin Sisters',
    ...
    POWERS_INDEX_BASE: process.env.KAI_NOVA_POWERS_BASE ||
        'https://raw.githubusercontent.com/Maliot100X/kai-nova-the-twin-sisters/main/powers',
    ...
    AVAILABLE_POWERS: () => path.join(POWERS_DIR, 'AVAILABLE.md'),

    ensure() {
        [WORKSPACE, NUCLEUS, path.join(NUCLEUS, 'memory'),
            path.join(POWERS_DIR)].forEach(d => {
